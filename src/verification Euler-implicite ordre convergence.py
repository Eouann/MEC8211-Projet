...
def Temperatures(N_spatial, N_temporel, T_x_0=T_x_0, T_x_inf=T_x_inf, alpha=alpha, rho=rho, cp=cp, h=h):
    """Fonction de calcul des temp�ratures en diff�rences finies avec terme source"""
    ...
    for n in range(1, N_temporel):
        # Mise � jour de vectB pour la condition de Dirichlet en x = 0
        ...
        # La condition de Robin est d�j� g�r�e hors de la boucle
...
def convergence_et_erreur(N_spatial_list, N_temporel):
    ...
    # R�gression lin�aire pour ordre de convergence
